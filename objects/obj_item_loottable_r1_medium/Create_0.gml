...
table = new RDTable();
table.add_entry(20, new CoinDrop(1));
table.add_entry(20, new CoinDrop(3));
table.add_entry(5, new ItemDrop(obj_ingredient_root, {}, false, true));
table.add_entry(2, new ItemDrop(obj_ingredient_slewleaf, {}, false, true));
