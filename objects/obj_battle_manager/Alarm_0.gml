...
show_debug_message("After player attack");
...
if (check_for_end()) {
    ...
    show_debug_message($"Going to battle end ... {alarm[BattleManagerEvents.BattleEnd]}");
} else {
    alarm[BattleManagerEvents.EnemyAttack] = TIME_SECOND;
    show_debug_message($"Going to enemy attack ... {alarm[BattleManagerEvents.EnemyAttack]}");
}
