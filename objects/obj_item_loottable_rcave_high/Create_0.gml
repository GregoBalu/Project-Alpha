...
table = new RDTable();
table.add_entry(10, new CoinDrop(1));
table.add_entry(5, new CoinDrop(3));
table.add_entry(5, new ItemDrop(obj_item_health_potion, {}, false, true));
table.add_entry(2, new ItemDrop(obj_talent_star, {}, false, true));
...
table.add_entry(5, new ItemDrop(obj_item_pickup_inventory_base, {
    inventory_item: obj_ring_of_sorrow
}, true, true));
