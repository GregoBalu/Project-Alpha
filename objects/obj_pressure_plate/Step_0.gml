...
if (_id != noone) {
    ...
    if (state == PressurePlateState.NotPressed) {
        ...
        audio_play_sound_at(snd_click, x, y, 0, 0, 32, 1, false, AUDIO_PRIO_NOISE, 1, 0, random_range(0.9,1.1));
    }
    ...
    if (do_reset && state == PressurePlateState.Pressed) {
        ...
        audio_falloff_set_model(audio_falloff_linear_distance);
        audio_play_sound_at(snd_clack, x, y, 0, 0, 32, 1, false, AUDIO_PRIO_NOISE, 1, 0, random_range(0.9,1.1));
    }
}
